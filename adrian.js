  ...
  conn.sendMessage(m.chat, {
    ...
    contextInfo: {
      externalAdReply: {
        ...
        body: 'AryBOT',
        thumbnailUrl: "https://telegra.ph/file/f293dba92d07dbd49274d.jpg",
        sourceUrl: "-",
        mediaType: 1,
...
( Q.S ${res.result.data.surah.name.transliteration.id} : ${res.result.data.number.inSurah} )`
		...
		case 'brainly':{
            ...
            let ppnyauser = await await conn.profilePictureUrl(m.sender, 'image').catch(_=> 'https://telegra.ph/file/f293dba92d07dbd49274d.jpg')
